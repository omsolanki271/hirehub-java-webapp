		...
		<div class="row justify-content-center">
			<div class="col-lg-10">
				...
				<div class="page-header mb-4">
					...
					<p>Modify the title, category, location, status, or details of this listing.</p>
				</div>
					...
					<form action="Updatejob" method="post" class="needs-validation" novalidate>
						...
						<div class="form-group mb-4">
							...
							<div class="input-group">
								...
								<input type="text" name="title" class="form-control border-left-0" 
									...
									placeholder="e.g. Senior Java Developer" value="<%=j.getTitle()%>" required>
						...
						<div class="form-row mb-3">
							...
							<div class="form-group col-md-4 mb-4">
								...
								<select name="location" class="custom-select" style="height: 44px;" required>
									<option value="<%=j.getLocation()%>"><%=j.getLocation()%> (Current)</option>
							...
							<div class="form-group col-md-4 mb-4">
								...
								<select name="category" class="custom-select" style="height: 44px;" required>
									<option value="<%=j.getCategory()%>"><%=j.getCategory()%> (Current)</option>
							...
							<div class="form-group col-md-4 mb-4">
								...
								<select name="status" class="custom-select" style="height: 44px;">
									<option value="<%=j.getStatus()%>"><%=j.getStatus()%> (Current)</option>
						...
						<div class="form-group mb-4">
							...
							<textarea name="description" class="form-control" rows="6" 
								placeholder="Describe core duties, requirements, expectations..." required><%=j.getDescription()%></textarea>
						...
						<div class="d-flex align-items-center justify-content-between pt-3 border-top" style="border-color: var(--border-color) !important;">
							<a href="view_jobs.jsp" class="btn btn-light px-4 py-2 font-weight-bold" style="border-radius: var(--radius-sm);">
								<i class="fa-solid fa-arrow-left mr-1"></i> Back to Jobs List
							</a>
							<button type="submit" class="btn btn-success-gradient px-4 py-2">
								<i class="fa-solid fa-check-double mr-1"></i> Save Changes
							</button>
						</div>
