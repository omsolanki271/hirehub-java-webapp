...
<!-- Font Awesome 6.5.2 (Latest Stable) -->
<link rel="stylesheet"
...
<!-- Embedded Custom Styling System to bypass caching and deployment sync delays -->
<style type="text/css">
:root {
  ...
  --gradient-success: linear-gradient(135deg, #0d9488 0%, #10b981 100%);
  ...
  --shadow-success: 0 10px 20px -5px rgba(13, 148, 136, 0.3);
...
.hero-title {
  ...
  line-height: 1.15;
  background: linear-gradient(to right, var(--white) 60%, #a5b4fc 100%);
...
.btn-success-gradient:hover {
  transform: translateY(-2px);
  box-shadow: 0 12px 22px rgba(13, 148, 136, 0.45);
  opacity: 0.95;
}
...
/* Modern Centered Cards (Login & Signup) */
.auth-bg {
